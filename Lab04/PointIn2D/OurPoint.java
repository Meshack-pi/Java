...
//----------------------------------
   ...
   public OurPoint(double xcord, double ycord){
    xCoord =xcord;
    yCoord = ycord;
   }
...
//------------------------------------------------
   ...
   public static void main (String [] args)  {
      ...
      System.out.println( "Distance from (0,0) to (-5, -12) is: " + distance);
      q.setX(3);
      q.setY(4);
      ...
      System.out.println( "Distance from (0,0) to (3,4) is: " + distance);
